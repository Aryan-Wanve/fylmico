      ...
      {locations.map((location) => (
        ...
        >
          ...
          <button
            ...
            className="absolute top-2 right-2 hidden h-7 w-7 place-items-center rounded-full text-[#667085] group-hover:grid hover:bg-red-50 hover:text-red-600 dark:text-[#878ca0]"
