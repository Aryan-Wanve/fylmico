      ...
      {characters.map((character) => (
        ...
        >
          <button
            ...
            className="absolute top-3 right-3 hidden h-7 w-7 place-items-center rounded-full text-[#667085] group-hover:grid hover:bg-red-50 hover:text-red-600 dark:text-[#878ca0]"
