...
export function CalendarEmptyView({ label }: { label: string }) {
  return (
    <div className="grid min-h-[28rem] place-items-center rounded-2xl border border-black/[0.06] bg-white text-center shadow-[0_1rem_3rem_rgba(53,45,124,0.05)]">
      <div>
        <div className="mx-auto grid h-14 w-14 place-items-center rounded-full bg-[#654cff]/10 text-[#654cff]">
          <CalendarClock className="h-6 w-6" />
        </div>
        <h3 className="mt-4 text-lg font-bold text-[#11142c]">
