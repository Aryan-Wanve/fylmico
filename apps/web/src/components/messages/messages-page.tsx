    ...
    return workspace.chatRooms.map((room) => {
      ...
      const pending: ChatMessageItem[] = queued
        ...
        .map((entry) => ({
          ...
          authorAvatarUrl: workspace.user.avatarUrl,
    ...
    <div className="grid grid-cols-1 gap-6 p-4 sm:p-6 lg:p-8">
      <div className="flex items-center justify-between gap-3">
        ...
        {connectionStatus === "disconnected" ? (
          ...
          <span className="shrink-0 rounded-full bg-black/[0.04] px-3 py-1 text-xs font-bold text-[#667085] dark:bg-white/[0.06] dark:text-[#878ca0]">
            Connecting…
          </span>
        ) : null}
      </div>
                ...
                >
                  {hasMoreOlder ? (
                    <div className="mb-3 flex justify-center">
                      <button
                        className="rounded-full bg-black/[0.04] px-3 py-1 text-xs font-semibold text-[#667085] hover:bg-black/[0.07] disabled:opacity-50 dark:bg-white/[0.06] dark:text-[#878ca0] dark:hover:bg-white/[0.1]"
                  ...
                  {typingUsers.length > 0 ? (
                    <p className="pb-1 text-xs font-semibold text-[#667085] italic dark:text-[#878ca0]">
                      {typingUsers.join(", ")}{" "}
