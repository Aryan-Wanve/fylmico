...
function ReadStatusIcon({
  ...
  if (status === "sending") {
    return <Clock className="h-3 w-3 text-[#667085] dark:text-[#878ca0]" />;
  }
  if (status === "read") {
  ...
  if (status === "delivered") {
    return (
      <CheckCheck className="h-3 w-3 text-[#667085] dark:text-[#878ca0]" />
    );
  }
  return <Check className="h-3 w-3 text-[#667085] dark:text-[#878ca0]" />;
}
    ...
    >
      ...
      <div className="min-w-0 flex-1">
        {isReply && parentAuthorName ? (
          <div className="mb-0.5 flex items-center gap-1 text-xs text-[#667085] dark:text-[#878ca0]">
        ...
        {isEditing ? (
          <div className="mt-0.5 grid gap-1.5">
            ...
            <div className="flex items-center gap-2 text-xs font-semibold">
              ...
              <button
                className="text-[#667085] hover:underline dark:text-[#878ca0]"
          ...
          <div className="flex items-center gap-1.5">
            <p className="mt-0.5 text-sm leading-relaxed text-[#3a3f57] dark:text-[#b4b8cc]">
              ...
              {message.editedAt && grouped ? (
                <span className="ml-1 text-xs text-[#667085] dark:text-[#878ca0]">
                  (edited)
                </span>
              ) : null}
            </p>
            {grouped ? (
              <span className="mt-0.5 text-xs whitespace-nowrap text-[#667085] opacity-0 group-hover:opacity-100 dark:text-[#878ca0]">
                {displayTime}
              </span>
            ) : null}
          </div>
        ...
        <div className="mt-1.5 flex flex-wrap items-center gap-1.5">
          ...
          <div className="relative">
            <button
              ...
              className="grid h-6 w-6 place-items-center rounded-full text-[#667085] opacity-0 group-hover:opacity-100 hover:bg-black/[0.05] dark:text-[#878ca0] dark:hover:bg-white/[0.06]"
          ...
          <button
            className="ml-1 flex items-center gap-1 text-xs font-semibold text-[#667085] opacity-0 group-hover:opacity-100 hover:text-[var(--fylmico-accent)] dark:text-[#878ca0]"
            onClick={onReply}
            type="button"
          >
            <CornerUpLeft className="h-3 w-3" />
          ...
          {canEdit && !isEditing ? (
            <button
              className="flex items-center gap-1 text-xs font-semibold text-[#667085] opacity-0 group-hover:opacity-100 hover:text-[var(--fylmico-accent)] dark:text-[#878ca0]"
