    ...
    <div className="grid content-start gap-5 rounded-2xl border border-black/[0.06] bg-white p-5 shadow-[0_1rem_3rem_rgba(53,45,124,0.05)] dark:border-white/[0.08] dark:bg-[#171a28]">
      ...
      <div>
        ...
        <ul className="mt-3 grid gap-1.5">
          {members.map((member) => (
            <li
              className="flex items-center justify-between text-xs text-[#667085] dark:text-[#878ca0]"
              key={member.id}
            >
      ...
      <div className="grid gap-1 border-t border-black/5 pt-4 dark:border-white/[0.06]">
        <div className="flex items-center justify-between py-1.5">
          <span className="flex items-center gap-2.5 text-sm font-semibold text-[#3a3f57] dark:text-[#b4b8cc]">
            <Bell className="h-4 w-4 text-[#667085] dark:text-[#878ca0]" />
            Notifications
          </span>
        ...
        >
          <span className="flex items-center gap-2.5 text-sm font-semibold text-[#3a3f57] dark:text-[#b4b8cc]">
            <FileText className="h-4 w-4 text-[#667085] dark:text-[#878ca0]" />
            Files
          </span>
          <ChevronRight className="h-3.5 w-3.5 text-[#667085] dark:text-[#878ca0]" />
        </button>
        <button
          className="flex items-center justify-between py-1.5"
        ...
        >
          <span className="flex items-center gap-2.5 text-sm font-semibold text-[#3a3f57] dark:text-[#b4b8cc]">
            <ListChecks className="h-4 w-4 text-[#667085] dark:text-[#878ca0]" />
            Tasks
          </span>
          <ChevronRight className="h-3.5 w-3.5 text-[#667085] dark:text-[#878ca0]" />
        </button>
        ...
        >
          <span className="flex items-center gap-2.5 text-sm font-semibold text-[#3a3f57] dark:text-[#b4b8cc]">
            <CalendarDays className="h-4 w-4 text-[#667085] dark:text-[#878ca0]" />
            Events
          </span>
          <ChevronRight className="h-3.5 w-3.5 text-[#667085] dark:text-[#878ca0]" />
        </button>
