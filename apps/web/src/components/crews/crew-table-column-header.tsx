export function CrewTableColumnHeader() {
  return (
    <div className="flex items-center gap-4 border-b border-black/5 px-4 py-2.5 text-xs font-bold tracking-wide text-[#667085] uppercase dark:border-white/[0.06] dark:text-[#7d8299]">
