    ...
    <section className="min-w-0 rounded-2xl border border-black/[0.06] bg-white p-6 shadow-[0_1rem_3rem_rgba(53,45,124,0.05)] dark:border-white/[0.08] dark:bg-[#171a28]">
      ...
      <div className="mt-4">
        {task.shootId ? (
          ...
          <EditTaskCard onChanged={handleCardChanged} task={task} />
        ) : task.type === "storyboarding" ? (
          <StoryboardingTaskCard onChanged={handleCardChanged} task={task} />
        ) : task.type === "script-writing" ? (
          <ScriptingTaskCard onChanged={handleCardChanged} task={task} />
        ) : null}
      </div>
