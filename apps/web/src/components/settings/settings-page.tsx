...
export function SettingsPage() {
  ...
  return (
    <div className="grid grid-cols-1 gap-6 p-4 sm:p-6 lg:p-8">
      ...
      <div className="flex min-w-0 flex-wrap items-center justify-between gap-3 border-t border-black/5 pt-4 text-xs text-[#667085] dark:border-white/[0.06] dark:text-[#878ca0]">
