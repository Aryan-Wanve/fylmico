...
export function AuthSecurityNote() {
  return (
    <aside className="mt-4 flex w-full max-w-[27rem] shrink-0 items-center gap-4 rounded-xl bg-white/70 p-3 text-[#515568] shadow-[0_0.8rem_2rem_rgba(53,45,124,0.06)] backdrop-blur-xl">
