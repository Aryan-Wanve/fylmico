          ...
          <div className="grid gap-2">
            ...
            <div className="relative">
              ...
              <Input
                ...
                className="h-[3.55rem] rounded-lg border-[#11142c1c] pl-11 text-center text-lg tracking-[0.5em] text-[#15172b] shadow-[0_0.65rem_1.6rem_rgba(42,39,84,0.04)] placeholder:font-semibold placeholder:text-[#9296a4] focus-visible:border-[#654cff8c] focus-visible:ring-[#654cff1a] dark:text-[#f1f2f8] dark:placeholder:text-[#878ca0]"
                id="verify-code"
                inputMode="numeric"
                maxLength={6}
                name="code"
