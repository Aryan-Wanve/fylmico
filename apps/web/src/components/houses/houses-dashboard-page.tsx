    ...
    >
      ...
      <div className="mt-4 flex items-center gap-1.5">
        <button
          ...
          className={`grid h-8 w-8 place-items-center rounded-lg border border-black/10 hover:bg-black/[0.03] dark:border-white/10 dark:hover:bg-white/[0.05] ${house.isFavorite ? "text-amber-500" : "text-[#667085] dark:text-[#878ca0]"}`}
        ...
        <button
          ...
          className={`grid h-8 w-8 place-items-center rounded-lg border border-black/10 hover:bg-black/[0.03] dark:border-white/10 dark:hover:bg-white/[0.05] ${house.isPinned ? "text-[var(--fylmico-accent)]" : "text-[#667085] dark:text-[#878ca0]"}`}
          onClick={onTogglePin}
          type="button"
        >
          <Pin
        ...
        <button
          ...
          className="grid h-8 w-8 place-items-center rounded-lg border border-black/10 text-[#667085] hover:bg-black/[0.03] dark:border-white/10 dark:text-[#878ca0] dark:hover:bg-white/[0.05]"
