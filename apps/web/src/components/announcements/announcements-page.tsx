  ...
  return (
    <div className="grid grid-cols-1 gap-6 p-4 sm:p-6 lg:p-8">
      ...
      <div className="grid max-w-3xl grid-cols-1 gap-4">
        {loading ? (
          <p className="py-16 text-center text-sm text-[#667085] dark:text-[#878ca0]">
          ...
          <div className="grid place-items-center gap-2 rounded-2xl border border-dashed border-black/10 bg-white/60 p-12 text-center dark:border-white/10 dark:bg-white/[0.02]">
            <Megaphone className="h-6 w-6 text-[#667085] dark:text-[#878ca0]" />
              ...
              <div className="flex items-start justify-between gap-3">
                ...
                {isOwner ? (
                  <div className="flex shrink-0 items-center gap-1">
                    <button
                      className={`grid h-8 w-8 place-items-center rounded-lg ${
                        announcement.pinned
                          ...
                          : "text-[#667085] hover:bg-black/[0.04] dark:text-[#878ca0] dark:hover:bg-white/[0.06]"
                      }`}
                    ...
                    <button
                      className="grid h-8 w-8 place-items-center rounded-lg text-[#667085] hover:bg-red-50 hover:text-red-600 dark:text-[#878ca0] dark:hover:bg-red-500/10"
